...
public class BluuTemplate
{
	...
	public void ScriptMain(ScriptInterface bot)
	{
		...
		bot.SendPacket("%xt%zm%getQuests%40245%383%");
		...
		while (!bot.ShouldExit())
		{
            ...
            {
				if (!bot.Quests.IsAvailable(383)) StopBot("Please Finish the /yokaiboat and /dragonkoi storylines.");
				TempItemFarm("Piece of Pockey", 3, "dragonkoiz", "t1", "Left", 383);
				SafeQuestComplete(383);
			}
			StopBot("Successfully farmed Rank 10 Yokai Rep.", "dragonkoiz");
		}
