...
//Wrote by Tato, Template by ↓

public class BluuPurpleTemplate
{
	//-----------EDIT BELOW-------------//
	public int MapNumber = 2142069;
	public string SoloingClass = "Void Highlord"; //set class here
	public string FarmingClass = "Legion Revenant"; //set class here
	public readonly int[] SkillOrder = { 1, 4, 2, 3 };
	public int SaveStateLoops = 8700;
	public int TurnInAttempts = 10;
	public string[] RequiredItems = { 
		"Litch Knight",
		"Litch Knight's Hair",
		"Litch Knight's Locks",
		"Litch Knight's Visor",
		"Litch Knight's Head Plate",
		"Litch Knight's Hood + Visor",
		"Litch Knight's Cloak",
		"Litch Knight's Back Swords",
		"Litch Knight's Sword",
		"Litch Knight's Dual Swords",
		"Litch Knight's Sword + Whip",
		"Litch Knight's Whip",
		"Lunar Corvus",
		"Lunar Corvus Headdress",
		"Lunar Corvus Hair",
		"Lunar Corvus Cape",
		"Fancy Corvus",
		"Fancy Corvus Cape",
	...
	public int[] QuestList = { 8382, 8383, 8384, 8385 };
	//-----------EDIT ABOVE-------------//
	...
	public void ScriptMain(ScriptInterface bot)
	{
		...
		while (!bot.ShouldExit())
		{
			while (!bot.Player.Loaded) { }
					...
					ItemFarm("Saint Eta's Gauntlet", 1, true, true, 8383, "Saint Eta", "shinkansen");//Kotaro's birthday
					ItemFarm("Ezrajal's feather", 1, true, true, 8384, "Ezrajal", "timeinn");//inanitas' birthday		
					ItemFarm("Picture Of Byro-Dax Monstrosity", 1, true, true, 8382, "Byro-Dax Monstrosity", "byrodax");//Memet's birthday				
					bot.Sleep(500);				
