...
public class BluuPurpleTemplate
{
    ...
    public int[] Quanity = {5100, 10000, 1000};
	public string[] RequiredItems = {"Bone Dust", "Undead Energy", "Undead Essence"};
	...
	public void ScriptMain(ScriptInterface bot)
	{
        ...
        {        
            ...
            //ItemFarm(string ItemName, int ItemQuantity, string MapName, string CellName, string PadName, bool Temporary = false, int QuestID = 0, string MonsterName = "*")
            ItemFarm(RequiredItems[0], Quanity[0], "battleunderb", "Enter", "Spawn", false);
            ItemFarm(RequiredItems[1], Quanity[1], "battleunderb", "Enter", "Spawn", false);
            ItemFarm(RequiredItems[2], Quanity[2], "battleunderb", "Enter", "Spawn", false);
