	...
	public void ScriptMain(ScriptInterface bot)
	{
		...
		while (!bot.ShouldExit())
		{
			...
			while (!bot.Inventory.Contains("Diamond Token of Dage", 300))
				...
				//HuntItemFarm("Itemstuffs", quaninity, "mapName", truefalse, questid, "monstername")
				HuntItemFarm("Defeated Makai", 25, "tercessuinotlim", false, 4743, "Dark Makai");
				HuntItemFarm("Fluffy's Bones", 1, "dflesson", true, 4743, "Fluffy The Dracolich");
				HuntItemFarm("Carnax Eye", 1, "aqlesson", true, 4743, "Carnax");
				HuntItemFarm("Kathool Tentacle", 1, "deepchaos", true, 4743, "Kathool");
				HuntItemFarm("Red Dragon's Fang", 1, "lair", true, 4743, "Red Dragon");
				HuntItemFarm("Blood Titan's Blade", 1, "bloodtitan", true, 4743, "Blood Titan");
				SafeQuestComplete(4743);
