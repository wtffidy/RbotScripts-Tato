...
public class BluuTemplate
{
	...
	public string[] RequiredItems = {"Youthanize"};
	public string[] EquippedItems = { };
	public readonly int[] SkillOrder = { 1, 2, 3, 4,};
	...
	public void ScriptMain(ScriptInterface bot)
	{
		...
		bot.Log($"[{DateTime.Now:HH:mm:ss}] 🥔 ur taters done cookn'🥔");
		StopBot();
	}
	...
	*/
	...
	/// </summary>
	public void StopBot(string Text = "🥔 ur taters done cookn'🥔", string MapName = "yulgar", string CellName = "Enter", string PadName = "Spawn")
	{
		//Must have the following functions in your script:
		//SafeMapJoin
		//ExitCombat
