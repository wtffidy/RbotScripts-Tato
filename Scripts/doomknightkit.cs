...
public class BluuPurpleTemplate
{
	...
	public string[] RequiredItems = {"DoomKnight Weapon Kit, Dark Energy, Corrupt Spirit Orb, Dark Spirit Orb, Omnious Aura, Grumpy Warhammer"};
	...
	public void ScriptMain(ScriptInterface bot)
	{
		...
		while (!bot.ShouldExit())
		{
            ...
            {
        bot.Drops.Add("DoomKnight Weapon Kit, Dark Energy, Corrupt Spirit Orb, Dark Spirit Orb, Omnious Aura, Grumpy Warhammer");
       
        bot.Player.Join("boxes");
        bot.Player.Jump("Boss", "Left", false);
        bot.Player.HuntForItem("Sneeviltron", "Grumpy Warhammer", 1, false, true);
        bot.Player.RejectExcept("Grumpy Warhammer");
        bot.Player.Pickup("Grumpy Warhammer");
        
        
        bot.Player.Join("kitsune");
        bot.Player.Jump("Boss", "Left", false);
        bot.Player.HuntForItem("Kitsune", "No. 1337 Blade Oil", 1, true, true);
        
        bot.Player.Join("sandcastle");
        bot.Player.Jump("r7", "Left", false);
        bot.Player.HuntForItem("Chaos Sphinx", "Gold Brush", 1, true, true);
       
        bot.Player.Join("crashsite");
        bot.Player.Jump("Boss", "Left", false);
        bot.Player.HuntForItem("ProtoSartorium", "Non-abrasive Power Powder", 1, true, true);
       
        bot.Player.Join("necrocavern");
        bot.Player.Jump("r13", "Left", false);
        bot.Player.HuntForItem("Shadow Dragon", "ShadowDragon Hide", 3, true, true);
       
        bot.Player.Join("dragonplane");
        bot.Player.Jump("r9", "Left", false);
        bot.Player.HuntForItem("Moganth", "Moganth's Stone Sharpener", 1, true, true);
        
        bot.Player.Join("akiba");
        bot.Player.Jump("cave4boss", "Left", false);
        bot.Player.HuntForItem("Shadow Nukemichi", "Doom Lacquer Finish", 1, true, true);
        
        bot.Player.Join("dreamnexus");
        bot.Player.Jump("r2", "Left", false);
        bot.Player.HuntForItem("Dark Wyvern", "Dark Wyvern Hide Travel Case", 1, true, false);
        
        bot.Player.Jump("Blank", "Center", false);
        bot.Wait.ForCombatExit(1000);
        bot.Quests.EnsureComplete(2165);
        bot.Wait.ForDrop("DoomKnight Weapon Kit, Dark Energy, Corrupt Spirit Orb, Dark Spirit Orb, Omnious Aura");
        bot.Player.RejectExcept("DoomKnight Weapon Kit", "Dark Energy", "Corrupt Spirit Orb", "Dark Spirit Orb", "Omnious Aura");
	    bot.Player.PickupFast("DoomKnight Weapon Kit", "Dark Energy", "Corrupt Spirit Orb", "Dark Spirit Orb", "Omnious Aura");
		}
	...
	*/
    ...
    //ItemFarm("ItemName", ItemAmount, "MapName", "Enter", "Spawn", false, Questlist[#], HuntTrueFalse, "MonsterName");
	{
	/*
