...
{
	//-----------EDIT BELOW-------------//
	public int MapNumber = 13223;
	public string[] RequiredItems = {"Escherion's Helm", "unidentified 10", "gem of nulgath", "unidentified 13", "tainted gem", "dark crystal shard", "diamond of nulgath", "unidentified 19", "unidentified 30", "unidentified 24", "voucher of nulgath", "voucher of nulgath(non-mem)"};
